  ...
  return (
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Main navigation header">
        <div className="sm-logo" aria-label="IST Clock">
          <span style={{ fontFamily: '"degular", sans-serif', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', lineHeight: 1.4, userSelect: 'none' }}>
            <span style={{ fontSize: '1.05rem', fontWeight: 300, letterSpacing: '0.1em', color: menuButtonColor, fontVariantNumeric: 'tabular-nums', opacity: 0.9 }}>
              {istTime}
            </span>
            <span style={{ fontSize: '0.58rem', fontWeight: 300, letterSpacing: '0.22em', opacity: 0.45, textTransform: 'uppercase', color: menuButtonColor }}>
              IST
            </span>
          </span>
        </div>
